  ...
  return (
    ...
    >
            ...
            <div key={idx} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-4">
                  <a href={project.demo} className="flex items-center text-blue-400 hover:text-blue-600">
                    <ExternalLink className="w-5 h-5 mr-1" /> Live Demo
                  </a>
                  <a href={project.code} className="flex items-center text-blue-400 hover:text-blue-600">
      ...
      <footer className="bg-gray-800 py-6 text-center">
        <p className="text-gray-400">© 2024 Shivam Shrivastava. All rights reserved.</p>
      </footer>
    </div>
  );
}
